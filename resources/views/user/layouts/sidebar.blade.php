<div class="nk-sidebar nk-sidebar-fat nk-sidebar-fixed{{ (gui('user', 'sidebar')=='darker') ? ' is-dark' : ' is-light' }}" data-content="sidebarMenu">
                ...
                <div class="nk-sidebar-widget d-none d-xl-block">
                    ...
                    <ul class="user-account-data gy-1">
                        ...
                        <li>
                            ...
                            <div class="user-account-value">
                                <span class="sub-text">{{ money(auth()->user()->balance_locked('deposit'), base_currency(), ['dp' => 'display']) }}</span>
                            </div>
                        </li>
                        @endif
                        ...
                        <li>
                            ...
                            <div class="user-account-value">
                                <span class="sub-text">{{ money(auth()->user()->balance_locked('withdraw'), base_currency(), ['dp' => 'display']) }}</span>
                            </div>
                        </li>
                        @endif
                    </ul>

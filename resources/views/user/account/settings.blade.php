                                ...
                                <ul class="align-center gx-3">
                                    <li class="order-md-last">
                                        <div class="custom-control custom-switch mr-n2">
                                            <input type="checkbox" name="activity_log" class="custom-control-input quick-update-profile"{{ (isset($metas["setting_activity_log"]) && ($metas["setting_activity_log"] == "on")) ? ' checked' : '' }} id="activity-log" data-key="setting">
                        ...
                        <div class="between-center flex-wrap flex-md-nowrap g-3">
                            ...
                            <div class="nk-block-actions">
                                <ul class="align-center gx-3">
                                    <li class="order-md-last">
                                        <div class="custom-control custom-switch mr-n2">
                                            <input type="checkbox" name="unusual_activity" class="custom-control-input quick-update-profile"{{ (isset($metas["setting_unusual_activity"]) && ($metas["setting_unusual_activity"] == "on")) ? ' checked' : '' }} id="unusual-activity" data-key="setting">

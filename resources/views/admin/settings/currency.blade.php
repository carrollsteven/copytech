                                        ...
                                        <li>
                                            <div class="custom-control custom-control-sm custom-checkbox">
                                                <input type="checkbox" class="custom-control-input supported-cur-cb" name="supported_currency[{{ $code }}]"
                                                       id="supported-cur-{{ strtolower($code) }}"{{ (in_array($code, $supported_currency)) ? ' checked' : '' }}>
                                                <label class="custom-control-label" for="supported-cur-{{ strtolower($code) }}">{{ $name.' ('.$code.')' }}</label>
                                            </div>
                                        </li>
                                    @endforeach
                                </ul>

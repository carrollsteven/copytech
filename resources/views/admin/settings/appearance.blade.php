                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <select class="form-select" name="auth_skin">
                                                    ...
                                                    <option disabled value="dark-alter"{{ (sys_settings('ui_auth_skin', 'light')=='dark-alter') ? ' selected' : '' }}>{{ __("Colored") }}</option>
                                                </select>
                                            </div>
                                            <div class="form-note mt-1 fw-bold text-secondary">{{ __("Color Mode") }}</div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <select class="form-select" name="theme_skin_admin">
                                                    ...
                                                    <option disabled value="dodger"{{ (sys_settings('ui_theme_skin_admin')=='dodger') ? ' selected' : '' }}>{{ __("Dodger Blue") }}</option>
                                                    <option disabled value="prussian"{{ (sys_settings('ui_theme_skin_admin')=='prussian') ? ' selected' : '' }}>{{ __("Prussian Blue") }}</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <select class="form-select" name="theme_skin">
                                                    ...
                                                    <option disabled value="dodger"{{ (sys_settings('ui_theme_skin')=='dodger') ? ' selected' : '' }}>{{ __("Dodger Blue") }}</option>
                                                    <option disabled value="prussian"{{ (sys_settings('ui_theme_skin')=='prussian') ? ' selected' : '' }}>{{ __("Prussian Blue") }}</option>
                                                </select>
                                            </div>
                                            <div class="form-note mt-1 fw-bold text-secondary">{{ __("Color Theme") }}</div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <select class="form-select" name="sidebar_user">
                                                    ...
                                                    <option disabled value="lighter"{{ (sys_settings('ui_sidebar_user', 'white')=='lighter') ? ' selected' : '' }}>{{ __("Lighter") }}</option>
                                                    <option disabled value="colored"{{ (sys_settings('ui_sidebar_user', 'white')=='colored') ? ' selected' : '' }}>{{ __("Colored") }}</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <select class="form-select" name="sidebar_admin">
                                                    ...
                                                    <option disabled value="lighter"{{ (sys_settings('ui_sidebar_admin', 'darker')=='lighter') ? ' selected' : '' }}>{{ __("Lighter") }}</option>
                                                    <option disabled value="colored"{{ (sys_settings('ui_sidebar_admin', 'darker')=='colored') ? ' selected' : '' }}>{{ __("Colored") }}</option>
                                                </select>
                                            </div>

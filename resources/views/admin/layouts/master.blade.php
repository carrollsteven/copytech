...
@if(sys_settings('ui_theme_skin_admin', 'default') != 'default')
    <link rel="stylesheet" href="{{ asset('assets/css/skins/theme-'.sys_settings('ui_theme_skin_admin').'.css?ver=120') }}">
@endif
</head>
...
<script src="{{ asset('assets/js/app.admin.js?ver=120') }}"></script>
@stack('scripts')
